...
assert "тензор" in unquote_plus(driver.current_url, "utf-8").lower()
...
yandex_img_page = YandexImagesPage(driver)
assert driver.current_url == yandex_img_page.root_page  # "https://yandex.ru/images/"
...
# получаем ссылку на первую категори
...
assert driver.current_url == first_cat_link
